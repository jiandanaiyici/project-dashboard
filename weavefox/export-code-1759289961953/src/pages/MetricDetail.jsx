...
import { Card, Row, Col, Typography, Tag, Button, Space, Descriptions, Progress } from 'antd';
import { 
  ArrowLeftOutlined, 
  CheckCircleOutlined, 
  WarningOutlined, 
...
const getMetricDetail = (id) => {
  const metrics = {
    'code-coverage': {
      ...
      name: '代码覆盖率',
      category: '代码质量',
      description: '被自动化测试（单元测试/集成测试）覆盖的代码行数占总代码行数的比例',
      value: '85%',
      status: 'normal',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-6">
        ...
        <Card className={`mb-6 border-2 ${currentStatus.borderColor} ${currentStatus.bgColor}`}>
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            <div>
              <Space size="middle" className="mb-2">
                <Tag color={currentStatus.color} className="text-base py-1 px-3">
              ...
              <Title level={2} className="!mb-2">{metric.name}</Title>
          ...
          <Col xs={24} lg={8}>
            ...
            <Card title="操作建议">
              <Space direction="vertical" className="w-full">
                <Button block icon={<ToolOutlined />}>查看监控配置</Button>
                <Button block>设置告警规则</Button>
                <Button block type="primary">查看相关文档</Button>
              </Space>
            </Card>
          </Col>
        </Row>
