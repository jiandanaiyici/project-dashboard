...
import { 
  Users, Code, AlertTriangle, TrendingUp, Clock, 
  Activity, BarChart3, PieChart as PieChartIcon,
  Calendar, Download, Filter, Search, Bell
} from 'lucide-react';
import { motion } from 'framer-motion';

// Mock data
const teamMembers = [
  { id: 1, name: '张三', role: '前端开发', project: '项目A', saturation: 85, commits: 120, lines: 5000 },
  { id: 2, name: '李四', role: '后端开发', project: '项目B', saturation: 65, commits: 95, lines: 3200 },
  { id: 3, name: '王五', role: '测试工程师', project: '项目A', saturation: 45, commits: 30, lines: 1200 },
  { id: 4, name: '赵六', role: '产品经理', project: '项目C', saturation: 75, commits: 15, lines: 800 },
  { id: 5, name: '钱七', role: 'UI设计师', project: '项目B', saturation: 55, commits: 25, lines: 1500 },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center">
              ...
              <h1 className="text-2xl font-bold text-gray-900">前端应用管理大盘</h1>
            </div>
                ...
                >
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="text-sm text-gray-500">{member.role} · {member.project}</div>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="font-medium text-gray-900">{member.commits} 次提交</div>
                    <SaturationBar value={member.saturation} />
                    <div className="text-xs text-gray-500 mt-1">{member.saturation}% 饱和度</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <DashboardCard title="代码提交趋势" icon={Code}>
            <ResponsiveContainer width="100%" height={300}>
              <AreaChart data={commitData}>
                ...
                <Tooltip />
                <Legend />
                <Area type="monotone" dataKey="commits" name="提交次数" stroke="#8884d8" fill="#8884d8" fillOpacity={0.3} />
                <Area type="monotone" dataKey="lines" name="代码行数" stroke="#82ca9d" fill="#82ca9d" fillOpacity={0.3} />
              </AreaChart>
            </ResponsiveContainer>
          </DashboardCard>
          ...
          <DashboardCard title="风险预警趋势" icon={AlertTriangle}>
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={riskData}>
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="risk" name="风险指数" stroke="#EF4444" strokeWidth={2} />
              </LineChart>
            </ResponsiveContainer>
          </DashboardCard>
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold text-gray-900">{selectedMember.name} 详情</h2>
                <button 
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="text-lg font-semibold">{selectedMember.role}</div>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <div className="text-sm text-gray-600">所属项目</div>
                  <div className="text-lg font-semibold">{selectedMember.project}</div>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <div className="text-sm text-gray-600">提交次数</div>
                  <div className="text-lg font-semibold">{selectedMember.commits}</div>
                </div>
                <div className="bg-orange-50 p-4 rounded-lg">
                  <div className="text-sm text-gray-600">代码行数</div>
                  <div className="text-lg font-semibold">{selectedMember.lines.toLocaleString()}</div>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="text-right text-sm text-gray-600 mt-1">{selectedMember.saturation}%</div>
              </div>
